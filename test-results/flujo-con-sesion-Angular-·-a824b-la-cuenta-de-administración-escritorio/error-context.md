...
- Name: flujo/con-sesion.spec.ts >> Angular · recorrido con sesión >> el panel abre con la cuenta de administración
- Location: e2e/flujo/con-sesion.spec.ts:105:9
