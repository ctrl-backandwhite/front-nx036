...
- Name: flujo/con-sesion.spec.ts >> React · recorrido con sesión >> el catálogo enseña productos de verdad
...
Call log:
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <svg role="img" focusable="false" data-prefix="fas" aria-hidden="true" viewBox="0 0 576 512" data-icon="cart-shopping" xmlns="http://www.w3.org/2000/svg" class="svg-inline--fa fa-cart-shopping cart-splash__cart">…</svg> from <div role="status" class="cart-splash " aria-label="Cargando">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
