 ...
 * servicio compartido haría que marcar tres cuentas dejara marcadas tres reglas de margen al cambiar de
 ...
 * uso.
 *
 * <p>DUPLICADO A PROPÓSITO. El área de logística del panel tiene otra copia idéntica. Mientras las tres
 * áreas se porten en paralelo, compartir un fichero entre ellas significaría que cambiarlo rompe el
 * trabajo de otro equipo sin avisar. Cuando el panel se junte, esta clase es la primera candidata a
 * subir al sistema de diseño: no tiene una sola línea de negocio.
 */
