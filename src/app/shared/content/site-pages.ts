...
export const ABOUT: Record<string, DocContent> = {
  es: {
    ...
    sections: [
      ...
      { h: 'Cómo funciona', p: ['Conectas tu tienda con Shopify o WooCommerce. Eliges productos del catálogo, se publican en tu tienda y, cuando un cliente compra, el pedido se abastece con el proveedor y te devolvemos el número de seguimiento.'] },
      { h: 'Qué ofrece la plataforma', p: [
        ...
        'Cumplimiento automatizado: cada pedido se reenvía al proveedor y recibes seguimiento de principio a fin. Integraciones nativas con Shopify y WooCommerce.',
  ...
  en: {
    ...
    sections: [
      ...
      { h: 'How it works', p: ['Connect your store with Shopify or WooCommerce. Pick products from the catalog, publish them to your store, and when a customer buys, the order is fulfilled with the supplier and we return the tracking number.'] },
      { h: 'What the platform offers', p: [
        ...
        'Automated fulfillment: every order is forwarded to the supplier and you get end-to-end tracking. Native Shopify and WooCommerce integrations.',
  ...
  pt: {
    title: 'Sobre nós',
    intro: 'A NX036 é uma plataforma de comércio transfronteiriço que liga vendedores diretamente a fornecedores verificados na origem. Eliminamos intermediários e camadas de margem para que possa importar bestsellers, sincronizar o seu catálogo e cumprir encomendas sem complicações.',
    sections: [
      ...
      { h: 'Como funciona', p: ['Liga a sua loja com Shopify ou WooCommerce. Escolhe produtos do catálogo, são publicados na sua montra e, quando um cliente compra, a encomenda é abastecida com o fornecedor e devolvemos o número de rastreio.'] },
  ...
  zh: {
    ...
    sections: [
      ...
      { h: '运作方式', p: ['通过 Shopify 或 WooCommerce 连接您的店铺。从目录中挑选商品并发布到您的店面;当客户下单时,订单由供应商履行,我们返回跟踪单号。'] },
  ...
  fr: {
    ...
    sections: [
      ...
      { h: 'Comment ça marche', p: ['Connectez votre boutique avec Shopify ou WooCommerce. Choisissez des produits du catalogue, publiez-les sur votre vitrine, et lorsqu’un client achète, la commande est exécutée avec le fournisseur et nous vous renvoyons le numéro de suivi.'] },
  ...
  de: {
    title: 'Über uns',
    intro: 'NX036 ist eine Plattform für grenzüberschreitenden Handel, die Verkäufer direkt mit geprüften Lieferanten an der Quelle verbindet. Wir schalten Zwischenhändler und Margenaufschläge aus, damit du Bestseller importieren, deinen Katalog synchronisieren und Bestellungen unkompliziert erfüllen kannst.',
    sections: [
      ...
      { h: 'So funktioniert es', p: ['Verbinde deinen Shop mit Shopify oder WooCommerce. Wähle Produkte aus dem Katalog, veröffentliche sie in deinem Schaufenster, und wenn ein Kunde kauft, wird die Bestellung beim Lieferanten erfüllt und wir liefern die Sendungsnummer zurück.'] },
  ...
  it: {
    title: 'Chi siamo',
    intro: 'NX036 è una piattaforma di commercio transfrontaliero che collega i venditori direttamente a fornitori verificati all’origine. Eliminiamo intermediari e margini superflui così puoi importare bestseller, sincronizzare il tuo catalogo ed evadere gli ordini senza complicazioni.',
    sections: [
      ...
      { h: 'Come funziona', p: ['Collega il tuo negozio con Shopify o WooCommerce. Scegli prodotti dal catalogo, pubblicali nella tua vetrina e, quando un cliente acquista, l’ordine viene evaso con il fornitore e ti restituiamo il numero di tracciamento.'] },
  ...
  nl: {
    ...
    sections: [
      ...
      { h: 'Hoe het werkt', p: ['Verbind je winkel met Shopify of WooCommerce. Kies producten uit de catalogus, publiceer ze in je etalage en wanneer een klant koopt, wordt de bestelling bij de leverancier afgehandeld en geven we het trackingnummer terug.'] },
